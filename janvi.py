...
logo=f"""  
     [white]88""Yb  dP"Yb  Yb  dP [red]X
     [green]88__dP dP   Yb  YbdP  
     [white]88"Yb  Yb   dP  dPYb  
     [green]88  Yb  YbodP  dP  Yb [red]D
[red]{str('━'*38)}
[white][[green]-[white]][green] AUTHOR   :  ADNAN CHOWDHURY 
[white][[green]-[white]][green] STATUS   :  RANDOM CLONE
[white][[green]-[white]][green] VERSION  :  [red]NULL
[red]{str('━'*38)}"""
...
def uoa():
    ...
    return f"Mozilla/5.0 (Linux; Android 7.0; Neffos X1 Lite Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver} {ver2}Mobile Safari/537.36"
